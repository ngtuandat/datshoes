        ...
        {listPurchase && listPurchase?.length > 0 ? (
          <div>
            {listPurchase?.map((item, idx) => (
              <div
                className="bg-[rgb(33,43,54)] rounded-xl mb-4 p-6 "
                key={idx}
              >
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-5">
                    ...
                    <div className="text-white">
                      <p className="text-xl font-bold">{item.nameProd}</p>
          ...
          <div>
            <p className="flex text-white w-full justify-center items-center text-2xl font-bold py-40 opacity-50">
              Bạn chưa từng mua đơn hàng nào!!
            </p>
            <button>Mua sắm nàoo</button>
          </div>
        )}
      </div>
    </div>
